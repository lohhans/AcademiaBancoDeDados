...
public class ControleAtualizarEnderecoFuncionario implements Initializable {

    private Fachada fachada;

    public ControleAtualizarEnderecoFuncionario(){
    ...
    private void acaoAtualizarEnderecoCliente(ActionEvent event){
        try {
            fachada.atualizarEnderecoFuncionario(cpf.getText(), cep.getText(), numero.getText(), rua.getText(), bairro.getText(), cidade.getText());
