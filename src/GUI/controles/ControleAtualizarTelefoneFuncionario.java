...
public class ControleAtualizarTelefoneFuncionario implements Initializable {

    private Fachada fachada;

    public ControleAtualizarTelefoneFuncionario(){
    ...
    @FXML
    private void acaoAtualizarTelefoneFuncionario(ActionEvent event){
        try {
            fachada.atualizarTelefoneFuncionario(cpf.getText(), novoTelefone.getText());
