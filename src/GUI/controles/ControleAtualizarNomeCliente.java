...
public class ControleAtualizarNomeCliente implements Initializable {

    private Fachada fachada;

    public ControleAtualizarNomeCliente(){
    ...
    @FXML
    private void acaoAtualizarNomeCliente(ActionEvent event){
        try {
            fachada.atualizarNomeCliente(cpf.getText(), novoNome.getText());
